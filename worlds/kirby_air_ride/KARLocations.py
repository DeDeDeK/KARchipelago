...
CITY_TRIAL_LOCATION_TABLE: dict[str, KARLocationData] = {
    ...
    CTLocation.PICKUP_100_ITEMS: KARLocationData(3, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_SOUND_TEST_ITEM_BOUNCE),
    CTLocation.PICKUP_500_ITEMS: KARLocationData(4, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_PAUSE_SCREEN_POWERUPS),
    ...
    CTLocation.GET_TRAMPLED_BY_DYNA_BLADE: KARLocationData(
        50, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_FILLER_BOX_4
    ),
    CTLocation.BREAK_5_OF_HUGE_PILLARS_THAT_APPEAR: KARLocationData(
        51, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_SOUND_TEST_HUGE_PILLAR
    ),
    CTLocation.BREAK_PILLAR_WITHIN_40S: KARLocationData(52, KARRegion.CITY_TRIAL),
    CTLocation.STEAL_8_FROM_TAC: KARLocationData(
        53, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_SOUND_TEST_TAC_CHALLENGE
    ),
    CTLocation.THE_METEOR_ATTACKS_CITY_3: KARLocationData(
        54, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_SOUND_TEST_FLYING_METEOR
    ),
    CTLocation.USE_UP_ONE_OF_RESTORATION_AREAS: KARLocationData(55, KARRegion.CITY_TRIAL),
    CTLocation.FILL_IN_100_CHECKLIST_BLOCKS: KARLocationData(56, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_ENDING),
    CTLocation.ENTER_CASTLE_CHAMBER: KARLocationData(57, KARRegion.CITY_TRIAL),
    CTLocation.FLY_THROUGH_RINGS_IN_SKY_5X: KARLocationData(
        58, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_DRAGOON_PART_B
    ),
    CTLocation.BUST_STAR_POLE: KARLocationData(59, KARRegion.CITY_TRIAL),
    CTLocation.BUST_STAR_POLE_10X: KARLocationData(60, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_FILLER_BOX_5),
    ...
    CTLocation.DESTROY_ALL_HOUSES: KARLocationData(69, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_HYDRA_PART_X),
    ...
    CTLocation.BREAK_A_CPUS_MACHINE_5_X: KARLocationData(78, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_PURPLE_KIRBY),
    ...
    CTLocation.USE_FIREWORKS_TO_KO_RIVALS_10X: KARLocationData(
        97, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_GREEN_KIRBY
    ),
    ...
    CTLocation.UNLOCK_DRAGOON_CHECKLIST: KARLocationData(
        110, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_DRAGOON_FREE_RUN
    ),
    CTLocation.UNLOCK_HYDRA_CHECKLIST: KARLocationData(111, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_HYDRA_FREE_RUN),
    ...
    CTLocation.BUST_WARPSTAR_ON_SWERVE_STAR: KARLocationData(
        115, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_SOUND_TEST_LIGHTHOUSE
    ),
    CTLocation.BUST_FORMULA_STAR_ON_TURBO_STAR: KARLocationData(116, KARRegion.CITY_TRIAL),
    CTLocation.BUST_SLICK_STAR_ON_FORMULA_STAR: KARLocationData(
        117, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_SOUND_TEST_STATION_FIRE
    ),
    ...
    CTLocation.COMPLETE_DRAGOON_AND_HYDRA: KARLocationData(
        120, KARRegion.CITY_TRIAL, KARItemName.CT_REWARD_WHITE_KIRBY
    ),
}


AIR_RIDE_LOCATION_TABLE: dict[str, KARLocationData] = {
    ARLocation.RACE_100_LAPS: KARLocationData(121, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_NEBULA_BELT_COURSE),
    ARLocation.RACE_300_LAPS: KARLocationData(122, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_MUSIC_NEBULA),
    ARLocation.GLIDE_FOR_30_MINUTES: KARLocationData(123, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_META_KNIGHT),
    ARLocation.GLIDE_FOR_1_HOUR: KARLocationData(124, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_SPECIAL_MACHINE_INTROS),
    ARLocation.DEFEAT_300_OF_YOUR_ENEMIES: KARLocationData(125, KARRegion.AIR_RIDE),
    ARLocation.DEFEAT_1000_OF_YOUR_ENEMIES: KARLocationData(126, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_KING_DEDEDE),
    ...
    ARLocation.SWALL_SWORD_KNIGHT_3_AND_FIRST: KARLocationData(
        129, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_GREEN_KIRBY
    ),
    ...
    ARLocation.RACE_ALL_OF_STANDARD_AIR_RIDE_COURSES: KARLocationData(
        205, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_WHEELIE_BIKE
    ),
    ARLocation.LAST_TO_FIRST_FINAL_LAP: KARLocationData(206, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_WHEELIE_SCOOTER),
    ...
    ARLocation.FIRST_WHILE_FLYING_THROUGH_AIR: KARLocationData(
        209, KARRegion.AIR_RIDE, KARItemName.AR_REWARD_WINGED_STAR
    ),
...
TOP_RIDE_LOCATION_TABLE: dict[str, KARLocationData] = {
    TRLocation.CROSS_GOAL_20: KARLocationData(241, KARRegion.TOP_RIDE, KARItemName.TR_REWARD_GREEN_KIRBY),
    ...
    TRLocation.LAP_NO_WALLS_AND_FIRST: KARLocationData(
        248, KARRegion.TOP_RIDE, KARItemName.TR_REWARD_MYSTERY_ITEM_SET_RULE
    ),
    ...
    TRLocation.NOITEMS_FIRST_ALL_COURSES: KARLocationData(251, KARRegion.TOP_RIDE, KARItemName.TR_REWARD_LANTERN_ITEM),
    TRLocation.COLLECT_500_ITEMS: KARLocationData(252, KARRegion.TOP_RIDE, KARItemName.TR_REWARD_WHO_PAINT_ITEM),
    TRLocation.ALL_COURSES_NO_BOOST: KARLocationData(253, KARRegion.TOP_RIDE, KARItemName.TR_REWARD_FILLER_BOX_1),
